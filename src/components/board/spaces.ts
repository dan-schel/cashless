...
export const spaces = [
  ...
  { id: "chest-2", column: 0, row: 3, category: null },
  { id: "orange-2", column: 0, row: 2, category: "orange" },
  { id: "orange-3", column: 0, row: 1, category: "orange" },
  { id: "free-parking", column: 0, row: 0, category: null },
  { id: "red-1", column: 1, row: 0, category: "red" },
  { id: "chance-2", column: 2, row: 0, category: null },
